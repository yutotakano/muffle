...
module Muffle.Discord.Generated.Schemas.ScheduledEventResponse where
...
data ScheduledEventResponse = ScheduledEventResponse
...
instance FromJSON ScheduledEventResponse where
    parseJSON = withObject "ScheduledEventResponse" $ \o ->
