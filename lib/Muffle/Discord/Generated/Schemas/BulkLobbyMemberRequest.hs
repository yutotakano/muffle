...
instance FromJSON BulkLobbyMemberRequestFlagsNullableInnerNullableInner where    parseJSON (Number 1) = pure BulkLobbyMemberRequestFlagsNullableInnerNullableInnerEnum1
