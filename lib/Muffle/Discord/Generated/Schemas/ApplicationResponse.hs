...
instance FromJSON ApplicationResponse where
    parseJSON = withObject "ApplicationResponse" $ \o ->
        ApplicationResponse <$>
            o .: "bot"
            <*> o .: "bot_public"
...
instance FromJSON ApplicationResponseIntegrationTypesConfigNullableInner where
    parseJSON = withObject "ApplicationResponseIntegrationTypesConfigNullableInner" $ \_ -> pure ApplicationResponseIntegrationTypesConfigNullableInner